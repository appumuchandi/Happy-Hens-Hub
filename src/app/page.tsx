...
function LandingPageContent() {
    ...
    const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
        <svg
            ...
            {...props}
        >
            <path d="M164.45,152.55a40,40,0,0,1-56.57,0L51.31,96A40,40,0,0,1,107.88,40l56.57,56.57A40,40,0,0,1,164.45,152.55Z" opacity="0.2"></path><path d="M208,120a56.78,56.78,0,0,1-12.33,35.45l-56.57,56.57a56,56,0,0,1-79.2-79.2L116.47,76.25a8,8,0,0,1,11.31,0L184.34,133A24,24,0,0,0,150.5,84.14l-23.76,23.76a8,8,0,0,1-11.31-11.31l23.76-23.76A40,40,0,0,1,196,128a39.43,39.43,0,0,1-8.24,24.58l-11.32,11.31a8,8,0,0,1-11.31-11.31L176.45,141A23.89,23.89,0,0,0,184,120a24,24,0,0,0-40.86-17l-56.56,56.57a24,24,0,1,0,33.93,33.94l56.57-56.57A24,24,0,0,0,184,120Zm-90.17,50.17a8,8,0,1,0-11.31,11.31l-24-24a8,8,0,1,0-11.32,11.32l24,24a23.93,23.93,0,0,0,34-34Z"></path>
        </svg>
    );
