...
function LandingPageContent() {
    ...
    const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
      <svg
        ...
        {...props}
      >
        <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm4.24 14.24c-1.41 1.41-3.32 2.24-5.25 2.24-3.31 0-6.05-2.29-6.86-5.35.42 2.37 2.44 4.11 4.86 4.11 2.76 0 5-2.24 5-5 0-2.02-1.22-3.76-2.98-4.52.88-.24 1.81-.38 2.78-.38 3.31 0 6.05 2.29 6.86 5.35-.42-2.37-2.44-4.11-4.86-4.11-2.76 0-5 2.24-5 5 0 2.02 1.22 3.76 2.98 4.52-.88.24-1.81.38-2.78.38z"/>
      </svg>
    );
