...
function LandingPageContent() {
    ...
    const LeafIcon = (props: React.SVGProps<SVGSVGElement>) => (
       <svg
        ...
        >
            <path
                d="M17.61,4.2C15.7,2.29,13.2,2.2,11.2,4.09c-2.7,2.59-2.23,7.33,1.2,9.91c2.81,2.12,6.6,2.16,8.68-0.2c0.02-0.02,0.04-0.04,0.06-0.06c2.03-2.31,2.02-5.75-0.02-8.06C20.01,4.88,18.56,4.1,17.61,4.2z M13.88,12.06c-2.3-1.89-2.58-4.93-0.8-7.22c1.4-1.81,3.79-2.1,5.6-0.7c1.86,1.45,2.1,3.94,0.61,5.81C17.43,11.85,15.63,12.68,13.88,12.06z"
            ></path>
            <path
                d="M19.18,11.45c-1.39-1.84-3.92-2.3-5.76-0.89c-1.89,1.45-2.61,4.06-1.56,6.18c2.4,4.91,8.13,6.23,11.12,2.28c2.7-3.56,1.38-8.63-2.8-11.12C19.86,7.72,19.51,7.5,19.18,7.3v0c-0.01,0-0.02,0-0.03-0.01c-0.5-0.29-1.04-0.49-1.59-0.59c-0.01,0-0.01-0.01-0.02-0.01c-1.53-0.28-3.09,0.28-4.22,1.38c-1.81,1.72-2.05,4.53-0.56,6.62c0.7,0.98,1.82,1.58,2.99,1.58c0.81,0,1.61-0.29,2.24-0.86C20.36,13.82,20.59,12.83,19.18,11.45z"
                opacity="0.5"
            ></path>
        </svg>
    );
